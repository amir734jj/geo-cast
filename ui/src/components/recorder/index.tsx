          ...
          <Container>
            <ButtonGroup size="lg" >
              {recording ?
                ...
                <Button variant="outline-success" disabled={playing || uploading} title="stop-recording" onClick={() => {
                  setRecording(true);
                  startRecording();
                }}>
              ...
              {mediaBlobUrl ? <Player mediaBlobUrl={mediaBlobUrl}
                ...
                render={(controls) => {
                  ...
                  </Button>) : (<Button variant="outline-primary" title="play-recording" disabled={recording} onClick={async () => {
                    await controls.play();
                  }}>
